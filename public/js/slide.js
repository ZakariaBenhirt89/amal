...
var Slide = /*#__PURE__*/function (_HTMLElement) {
  ...
  function Slide() {
    ...
    iframe.src = 'https://view.officeapps.live.com/op/view.aspx?src=' + (_this.hasAttribute('src') ? _this.getAttribute('src') : '') + '&embedded=true';
