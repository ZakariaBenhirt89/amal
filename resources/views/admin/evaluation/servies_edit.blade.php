                        ...
                        <div  style="border-top: 4px solid #18113c;" class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <form action="{{ route('admin.service.update',$services->id) }}" method="post" class="row">
                                    @csrf
                                    <!-- First name -->
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <input type="text" id="fname" class="form-control form-control-sm" name="service_name" value="{{ $services->service_name }}" placeholder="Service Name" required />
                                        </div>
