                        ...
                        <div  style="border-top: 4px solid #18113c;" class="card">
                            ...
                            <!--      <div class="d-lg-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    ...
                                    <form action="{{ route('admin.monitoring.update',$monitorings->id) }}" method="post" class="row">
                                    @csrf
                                    <!-- First name -->
                                            ...
                                            <select id="student" name="student_id" class="form-control form-control-sm" required>
                                                ...
                                                @isset($users)
                                                    @foreach($users as $user)
                                                        <option value="{{ $user->id }}" @if($user->id == $monitorings->student_id) selected @endif>{{$user->first_name}} {{$user->last_name}}</option>
                                                    @endforeach
                                                @endisset()
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <input type="text" id="fname" class="form-control form-control-sm" name="service" value="{{ $monitorings->service }}" placeholder="Service" required />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label class="form-label" for="Supervisor">Supervisor </label>
                                            <input type="text" id="Supervisor" class="form-control form-control-sm" name="Supervisor" value="{{ $monitorings->supervisor }}" placeholder="Supervisor" required />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label class="form-label" for="supervisor_email">Supervisor Email </label>
                                            <input type="text" id="supervisor_email" class="form-control form-control-sm" name="supervisor_email" value="{{ $monitorings->supervisor_email }}" placeholder="supervisor email" required />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label class="form-label" for="supervisor_phone">Supervisor Phone </label>
                                            <input type="text" id="supervisor_phone" class="form-control form-control-sm" name="supervisor_phone" value="{{ $monitorings->supervisor_phone }}" placeholder="supervisor phone" required />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label class="form-label" for="start">Start Rotation </label>
                                            <input type="text" id="start" class="form-control form-control-sm flatpickr flatpickr-input active input" name="start" value="{{ $monitorings->start }}" placeholder="Start Rotation" required />
                                        </div>
                                        <div class="mb-3 col-12 col-md-6">
                                            <label class="form-label" for="end">End Rotation </label>
                                            <input type="text" id="end" class="form-control form-control-sm flatpickr flatpickr-input active input" name="end" value="{{ $monitorings->end }}" placeholder="End Rotation" required />
                                        </div>
