                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    ...
                                    <!-- Form -->
                                    <form id="theForm" action="{{ route('admin.interships.update',$interships->id) }}" method="post" class="row">
                                        <!-- First name -->
                                        @csrf
                                            ...
                                            <select id="student" name="student_id" class="form-control form-control-sm" required="">
                                                ...
                                                @isset($users)
                                                    ...
                                                    @foreach($users as $user)
                                                        <option value="{{ $user->id }}" @if( $user->id == $interships->student_id ) selected @endif>{{ $user->first_name }} {{ $user->last_name }}</option>
                                                    @endforeach
                                                @endisset
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <input type="text" id="fname" class="form-control form-control-sm" name="title" value="{{ $interships->title }}" placeholder="Title" >
                                            @if ($errors->has('title'))
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <input type="text" id="lname" class="form-control form-control-sm" name="location" value="{{ $interships->location }}" placeholder="Interships Provided" >
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <input class="form-control form-control-sm flatpickr flatpickr-input" type="text" placeholder="Start Internship" value="{{ $interships->start }}" id="birth" name="start" readonly="readonly">
                                            @if ($errors->has('start'))
                                        ...
                                        <div class="mb-3 col-12 col-md-6">
                                            ...
                                            <input class="form-control form-control-sm flatpickr flatpickr-input" type="text" placeholder="End Internship" id="birth" value="{{ $interships->end }}" name="end" readonly="readonly">
                                            @if ($errors->has('end'))
                                        ...
                                        <div class="mb-3 col-12 col-md-12">
                                            ...
                                            <input type="text" id="lname" class="form-control form-control-sm" placeholder="Supervisor" value="{{ $interships->supervisor }}" name="supervisor" >
                                        ...
                                        <div class="mb-3 col-12 col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <div style="height: 99px !important;" id="editor">
                                                    {{ $interships->objectifs }}
                                                </div>
                                                <textarea class="form-control" name="editor" cols="10" hidden>{{ $interships->objectifs }}</textarea>
                                        ...
                                        <div class="mb-3 col-12 col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control form-control-sm" name="guidline" cols="10">{{ $interships->guidline }}</textarea>
