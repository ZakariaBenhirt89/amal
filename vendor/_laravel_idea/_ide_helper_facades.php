...
namespace Algolia\ScoutExtended\Facades {
    ...
    /**
     * @see \Algolia\ScoutExtended\Algolia::analytics
     * @method static \Algolia\AlgoliaSearch\AnalyticsClient analytics()
     * @see \Algolia\ScoutExtended\Algolia::client
     * @method static \Algolia\AlgoliaSearch\SearchClient client()
     * @see \Algolia\ScoutExtended\Algolia::index
     * @method static \Algolia\AlgoliaSearch\SearchIndex index(object|string $searchable)
     * @see \Algolia\ScoutExtended\Algolia::searchKey
     * @method static string searchKey(object|string $searchable)
     */
    class Algolia {}
}
...
namespace CloudinaryLabs\CloudinaryLaravel\Facades {
    ...
    /**
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getPublicId
     * @method static string getPublicId()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::destroyAsync
     * @method static \GuzzleHttp\Promise\PromiseInterface destroyAsync($publicId, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateAnimatedWEBPAsync
     * @method static \Cloudinary\Api\ApiResponse generateAnimatedWEBPAsync($tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::upload
     * @method static \Cloudinary\Api\ApiResponse upload(string $file, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::renameAsync
     * @method static \GuzzleHttp\Promise\PromiseInterface renameAsync($from, $to, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generatePDF
     * @method static void generatePDF($tag, $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateSpriteAsync
     * @method static void generateSpriteAsync($tag, $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::removeAllContextAsync
     * @method static \GuzzleHttp\Promise\PromiseInterface removeAllContextAsync(array $publicIds = [], array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::uploadAsync
     * @method static void uploadAsync($file, $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::createZip
     * @method static \Cloudinary\Api\ApiResponse createZip(array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::multi
     * @method static \Cloudinary\Api\ApiResponse multi($tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::removeAllTags
     * @method static \Cloudinary\Api\ApiResponse removeAllTags(array $publicIds = [], array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::explode
     * @method static \Cloudinary\Api\ApiResponse explode($publicId, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getPages
     * @method static mixed getPages()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getHeight
     * @method static mixed getHeight()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::removeTagAsync
     * @method static void removeTagAsync($tag, $publicIds = [], $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getImage
     * @method static \CloudinaryLabs\CloudinaryLaravel\Image getImage(string $publicId)
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::bootCloudinary
     * @method static void bootCloudinary()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getResponse
     * @method static \CloudinaryLabs\CloudinaryLaravel\Array getResponse()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::uploadApi
     * @method static void uploadApi()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::uploadVideo
     * @method static void uploadVideo($file, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::destroy
     * @method static \Cloudinary\Api\ApiResponse destroy($publicId, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::removeAllTagsAsync
     * @method static void removeAllTagsAsync($publicIds = [], $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::setUserPlatform
     * @method static void setUserPlatform()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getWidth
     * @method static mixed getWidth()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::setCloudinaryConfig
     * @method static void setCloudinaryConfig()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateImageFromText
     * @method static \Cloudinary\Api\ApiResponse generateImageFromText(string $text, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::explicit
     * @method static mixed explicit($publicId, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::unsignedUpload
     * @method static \Cloudinary\Api\ApiResponse unsignedUpload(string $file, string $uploadPreset, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getVideoTag
     * @method static \Cloudinary\Tag\VideoTag getVideoTag($publicId)
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateAnimatedMP4
     * @method static \Cloudinary\Api\ApiResponse generateAnimatedMP4($tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getFileType
     * @method static mixed getFileType()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateImageFromTextAsync
     * @method static \GuzzleHttp\Promise\PromiseInterface generateImageFromTextAsync($text, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::removeAllContext
     * @method static \Cloudinary\Api\ApiResponse removeAllContext(array $publicIds = [], array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getVersionId
     * @method static mixed getVersionId()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateAnimatedGIF
     * @method static \Cloudinary\Api\ApiResponse generateAnimatedGIF($tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getSize
     * @method static mixed getSize()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateAnimatedWEBMAsync
     * @method static \Cloudinary\Api\ApiResponse generateAnimatedWEBMAsync($tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getPlaceHolder
     * @method static mixed getPlaceHolder()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::admin
     * @method static void admin()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getVersion
     * @method static mixed getVersion()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::replaceTagAsync
     * @method static void replaceTagAsync($tag, $publicIds = [], $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateAnimatedWEBM
     * @method static \Cloudinary\Api\ApiResponse generateAnimatedWEBM($tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::createArchive
     * @method static \Cloudinary\Api\ApiResponse createArchive(array $options = [], null $targetFormat = null)
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getExtension
     * @method static mixed getExtension()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::search
     * @method static void search()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getPhash
     * @method static mixed getPhash()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateAnimatedWEBP
     * @method static \Cloudinary\Api\ApiResponse generateAnimatedWEBP($tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateAnimatedMP4Async
     * @method static \Cloudinary\Api\ApiResponse generateAnimatedMP4Async($tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::addContext
     * @method static \Cloudinary\Api\ApiResponse addContext($context, array $publicIds = [], array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getReadableSize
     * @method static string getReadableSize()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::createArchiveAsync
     * @method static \GuzzleHttp\Promise\PromiseInterface createArchiveAsync(array $options = [], null $targetFormat = null)
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getSignature
     * @method static mixed getSignature()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::explicitAsync
     * @method static \GuzzleHttp\Promise\PromiseInterface explicitAsync($publicId, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getFile
     * @method static \CloudinaryLabs\CloudinaryLaravel\File getFile(mixed|string $publicId)
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateSprite
     * @method static \Cloudinary\Api\ApiResponse generateSprite(string $tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::replaceTag
     * @method static \Cloudinary\Api\ApiResponse replaceTag(string $tag, array|string $publicIds = [], array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getAssetId
     * @method static mixed getAssetId()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generatePDFAsync
     * @method static \Cloudinary\Api\ApiResponse generatePDFAsync($tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getPath
     * @method static mixed getPath()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::downloadZipUrl
     * @method static string downloadZipUrl(array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getFileName
     * @method static string getFileName()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::addTagAsync
     * @method static void addTagAsync($tag, $publicIds = [], $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::addContextAsync
     * @method static \GuzzleHttp\Promise\PromiseInterface addContextAsync($context, array $publicIds = [], array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getOriginalFileName
     * @method static string getOriginalFileName()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::addTag
     * @method static \Cloudinary\Api\ApiResponse addTag(string $tag, array $publicIds = [], array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::downloadArchiveUrl
     * @method static string downloadArchiveUrl(array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getTimeUploaded
     * @method static mixed getTimeUploaded()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getSecurePath
     * @method static mixed getSecurePath()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::multiAsync
     * @method static \GuzzleHttp\Promise\PromiseInterface multiAsync($tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getVideo
     * @method static \CloudinaryLabs\CloudinaryLaravel\Video getVideo(mixed|string $publicId)
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::rename
     * @method static mixed rename($from, $to, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::uploadFile
     * @method static void uploadFile($file, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getImageTag
     * @method static \Cloudinary\Tag\ImageTag getImageTag($publicId)
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::unsignedUploadAsync
     * @method static void unsignedUploadAsync($file, $uploadPreset, $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::explodeAsync
     * @method static \GuzzleHttp\Promise\PromiseInterface explodeAsync($publicId, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::removeTag
     * @method static \Cloudinary\Api\ApiResponse removeTag(string $tag, array|string $publicIds = [], array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::getTags
     * @method static mixed getTags()
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::createZipAsync
     * @method static \GuzzleHttp\Promise\PromiseInterface createZipAsync(array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateAnimatedPNGAsync
     * @method static \Cloudinary\Api\ApiResponse generateAnimatedPNGAsync($tag, array $options = [])
     * @see \CloudinaryLabs\CloudinaryLaravel\CloudinaryEngine::generateAnimatedPNG
     * @method static \Cloudinary\Api\ApiResponse generateAnimatedPNG($tag, array $options = [])
     */
    class Cloudinary {}
}
